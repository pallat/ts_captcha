...
describe("Capcha", () => {
    ...
    describe("Test operator", () => {
        it("should show 2 + NINE when put 1 2 1 9", () => {
            ...
            expect(capcha.toString()).toEqual("2 + NINE");
        });
